...
> These contributing guidlines have been adopted from [GRASS GIS](https://github.com/OSGeo/grass).

There is more than one way of contributing to OpenPlains.
Here we will focus on contributions centered
around the main OpenPlains source code.

## Changing code and documentation

This guide covers contributing to the main version of OpenPlains source
...
OpenPlains [Gitter](https://gitter.im/tomorrownow/community).
...
```bash
origin  git@github.com:your_GH_account/OpenPlains.git (fetch)
origin  git@github.com:your_GH_account/OpenPlains.git (push)
```

For the following workflow, it is important that
"upstream" points to the tomorrownow/OpenPlains repository
...
of the source code is written in JavaScript + React, a significant portion is written in Python.
